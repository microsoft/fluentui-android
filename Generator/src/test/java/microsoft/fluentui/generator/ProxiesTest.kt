...
import microsoft.fluentui.generator.model.proxies.AppearanceProxy
...
class ProxiesTest {
    ...
    fun setup() {
        ...
        File(_root_ide_package_.microsoft.fluentui.generator.testProjectPath).deleteRecursively()
    }
...
//        testAP(Button(type = Button.Type.Text()), 0, "Button")
    ...
    fun `Button resources`() {
        ...
        Yaml().loadAs(document, FluentUIDocument::class.java).generate()
