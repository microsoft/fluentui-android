...
private val interpolatorsFilePath = global_projectSourcePath.plus("main/java/microsoft/flunetui/generator/Interpolators.kt")

fun clearInterpolatorsFile() {
    StringBuilder().apply {
        append(AUTOGENERATED_CODE_HEADER)
        append("\npackage microsoft.fluentui.generator\n")
        append("import android.support.v4.view.animation.PathInterpolatorCompat\n\n")
