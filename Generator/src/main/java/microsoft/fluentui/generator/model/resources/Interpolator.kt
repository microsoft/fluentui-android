...
private val interpolatorsFilePath = global_projectSourcePath.plus("main/java/com/microsoft/stardust/Interpolators.kt")
...
fun clearInterpolatorsFile() {
    StringBuilder().apply {
        ...
        append("fun createStardustInterpolator(x1: Float, y1: Float, x2: Float, y2: Float) = PathInterpolatorCompat.create(x1, y1, x2, y2)\n\n")
...
fun generateInterpolator(name: String, value: String) {
    ...
    File(interpolatorsFilePath).let { interpolatorsFile ->
        ...
        val interpolatorName = "stardustInterpolator${name.substringAfterLast("_").capitalize()}"
