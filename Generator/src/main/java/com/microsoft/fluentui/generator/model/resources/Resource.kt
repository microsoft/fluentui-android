...
fun generateProxyFile(
    ...
    StringBuilder().apply {
        ...
        var sizeName=""
        val sizeValues = ArrayList<String>()
        val variablesToAddForFontStyleDependency = ArrayList<String>()
        val variablesToAddForSizeDependency = ArrayList<String>()
        val variablesToAddForSizeWithoutDependency = ArrayList<String>()
