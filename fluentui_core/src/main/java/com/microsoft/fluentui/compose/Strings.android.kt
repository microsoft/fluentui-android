...
fun getString(string: Strings): String {
    ...
    return when (string) {
        ...
        Strings.Large -> resources.getString(R.string.fluentui_large)
        Strings.Medium -> resources.getString(R.string.fluentui_medium)
        Strings.Small -> resources.getString(R.string.fluentui_small)
        Strings.Subtitle -> resources.getString(R.string.fluentui_subtitle)
        else -> ""
    }
}