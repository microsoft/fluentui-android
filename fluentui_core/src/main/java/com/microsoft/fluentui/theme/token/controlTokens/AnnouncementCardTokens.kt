...
data class AnnouncementCardInfo(override val cardType: CardType = CardType.Elevated, val buttonType: ButtonStyle = ButtonStyle.TextButton) : BasicCardControlInfo()
@Parcelize
