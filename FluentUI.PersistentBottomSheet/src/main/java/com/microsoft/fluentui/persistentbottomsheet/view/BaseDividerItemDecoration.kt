...
package com.microsoft.fluentui.persistentbottomsheet.view
...
open class BaseDividerItemDecoration : DividerItemDecoration {
    ...
    constructor(context: Context, orientation: Int) : super(FluentUIContextThemeWrapper(context), orientation) {
        ...
        subHeaderDividerPadding = context.resources.getDimension(com.microsoft.fluentui.persistentbottomsheet.R.dimen.fluentui_list_sub_header_divider_padding)
