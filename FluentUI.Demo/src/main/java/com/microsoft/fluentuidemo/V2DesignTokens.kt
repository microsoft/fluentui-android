...
class V2DesignTokens : V2DemoActivity() {
    ...
    fun SetPreviewContent (tokenName: String, selectedToken: Any) {
        ...
        when (tokenName) {
            ...
            "Typography Tokens" -> Label(text = "Text", textStyle = selectedToken as FluentAliasTokens.TypographyTokens)
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setBottomBar {
            val globalTokensList = mapOf (
                "Neutral Color Tokens" to Pair (FluentGlobalTokens.NeutralColorTokens.values(), ::neutralColor),
                "Font Size Tokens" to Pair (FluentGlobalTokens.FontSizeTokens.values(), ::fontSize),
                "Line Height Tokens" to Pair (FluentGlobalTokens.LineHeightTokens.values(), ::lineHeight),
                "Font Weight Tokens" to Pair (FluentGlobalTokens.FontWeightTokens.values(), ::fontWeight),
                ...
                "Corner Radius Tokens" to Pair (FluentGlobalTokens.CornerRadiusTokens.values(), ::cornerRadius),
                "Stroke Width Tokens" to Pair (FluentGlobalTokens.StrokeWidthTokens.values() , ::strokeWidth),
            )

            val aliasTokensList = mapOf (
                "Brand Color Tokens" to Pair (FluentAliasTokens.BrandColorTokens.values(), FluentTheme.aliasTokens.brandColor),
                "Neutral Background Color Tokens" to Pair (FluentAliasTokens.NeutralBackgroundColorTokens.values(), FluentTheme.aliasTokens.neutralBackgroundColor),
                "Neutral Foreground Color Tokens" to Pair (FluentAliasTokens.NeutralForegroundColorTokens.values(), FluentTheme.aliasTokens.neutralForegroundColor),
                "Neutral Stroke Color Tokens" to Pair (FluentAliasTokens.NeutralStrokeColorTokens.values(), FluentTheme.aliasTokens.neutralStrokeColor),
                "Brand Background Color Tokens" to Pair (FluentAliasTokens.BrandBackgroundColorTokens.values(), FluentTheme.aliasTokens.brandBackgroundColor),
                "Brand Foreground Color Tokens" to Pair (FluentAliasTokens.BrandForegroundColorTokens.values(), FluentTheme.aliasTokens.brandForegroundColor),
                "Brand Stroke Color Tokens" to Pair (FluentAliasTokens.BrandStrokeColorTokens.values(), FluentTheme.aliasTokens.brandStroke),
                "Error And Status Color Tokens" to Pair (FluentAliasTokens.ErrorAndStatusColorTokens.values(), FluentTheme.aliasTokens.errorAndStatusColor),
                "Presence Color Tokens" to Pair (FluentAliasTokens.PresenceColorTokens.values(), FluentTheme.aliasTokens.presenceColor),
                "Typography Tokens" to Pair (FluentAliasTokens.TypographyTokens.values(), FluentTheme.aliasTokens.typography)
            )
                                                ...
                                                when (tokenName) {
                                                    "Neutral Color Tokens" ->
                                                        Icon(
                                                            ...
                                                            contentDescription = "",
                                                            tint = (tokenValue.second as (Enum<*>) -> Color).invoke(it)
                                                        )

                                                    "Shared Color Sets", "Shared Colors Tokens", "Neutral Background Color Tokens",
                                                    "Neutral Foreground Color Tokens", "Neutral Stroke Color Tokens", "Brand Background Color Tokens", "Brand Foreground Color Tokens",
                                                    "Brand Stroke Color Tokens", "Error And Status Color Tokens", "Presence Color Tokens" ->
                                                        Icon(
                                                            painter = painterResource(id = R.drawable.ic_fluent_square_24_filled),
                                                            contentDescription = "",
                                                    ...
                                                    "Brand Color Tokens" ->
                                                        Icon(
                                                            painter = painterResource(id = R.drawable.ic_fluent_square_24_filled),
                                                            contentDescription = "",
                                                            tint = (tokenValue.second as TokenSet<Enum<*>, Color>)[it]
                                                        )
                                                }
                                            }
                                        )
