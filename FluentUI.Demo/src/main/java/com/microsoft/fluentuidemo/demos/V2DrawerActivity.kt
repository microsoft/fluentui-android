...
import com.microsoft.fluentui.tokenized.drawer.rememberFluentModalDrawerState
...
class V2DrawerActivity : V2DemoActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setActivityContent {
            ...
            val drawerState = rememberFluentModalDrawerState(
                initialValue = FluentModalDrawerValue.Closed
            )
