...
class Toolbar : Toolbar {
    ...
    @JvmOverloads
    constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : super(FluentUIContextThemeWrapper(context,R.style.Theme_FluentUI), attrs, R.attr.toolbarStyle) {
